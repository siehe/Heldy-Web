            ...
            .then(res => {
                if (res.ok) {
                    dispatch(showWarning({
                        show: !isWarningShown,
                        text: alerts.addedToForum.text,
                        header: alerts.addedToForum.header
                    }));
                }
                ...
                <div className={styles.container}>
                    <div className={styles.header}>
                        <div className={styles.headerContent}>
                            ...
                            <span
                                className={styles.lecturer}>{task.author.surname && ("Lecturer: " + task.author.name + " " + task.author.surname.split("")[0].toUpperCase() + ".")}</span>
                        </div>
                        {isTaskProblems &&
                        <img src="https://image.flaticon.com/icons/png/512/64/64703.png" alt="problems"
